export const dict = {
  ...
  "app.meta.description": "Atos - The open source coding agent.",

  "home.title": "Atos | The open source AI coding agent",

  "temp.title": "atos | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by atos",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "atos TUI with the tokyonight theme",
  "temp.screenshot.alt": "atos TUI with tokyonight theme",
  "temp.logoLightAlt": "atos logo light",
  "temp.logoDarkAlt": "atos logo dark",
